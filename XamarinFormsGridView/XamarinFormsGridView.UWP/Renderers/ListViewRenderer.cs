...
[assembly: ExportRenderer(typeof(XamarinFormsGridView.Controls.GridView), typeof(CustomListViewRenderer))]
    ...
    public class CustomListViewRenderer : ListViewRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Xamarin.Forms.ListView> e)
        {
            ...
            if (Control != null)
            {
                ...
                var itemWidth = (double)list.GetValue(XamarinFormsGridView.Controls.GridView.MinItemWidthProperty);
        ...
        protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            if (e.PropertyName == "Width")
            {
                ...
                var itemMinSize = (double)list.GetValue(XamarinFormsGridView.Controls.GridView.MinItemWidthProperty);
